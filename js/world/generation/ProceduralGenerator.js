const _proceduralGenerator = {
	generateNatureObjects: function () {
		console.log(
			"[procedural_generator.js] Generating nature objects procedurally..."
		);
		const natureObjects = [];
		...
		const groveCenters = [
			{ x: -100, z: -80, density: 155, radius: 60 },
			{ x: 120, z: -150, density: 132, radius: 65 },
			{ x: 60, z: 100, density: 125, radius: 65 },
			{ x: -170, z: 140, density: 145, radius: 60 },
			{ x: 190, z: 20, density: 150, radius: 65 },
			{ x: 0, z: -180, density: 130, radius: 50 },
			{ x: -150, z: 20, density: 120, radius: 48 },
			{ x: 150, z: 150, density: 125, radius: 53 },
		];
		...
		console.log(
			`[procedural_generator.js] Generated ${natureObjects.length} objects.`
		);
